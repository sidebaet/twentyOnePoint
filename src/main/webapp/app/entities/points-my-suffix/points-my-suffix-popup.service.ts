...
@Injectable()
export class PointsMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.pointsModalRef(component, new PointsMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    pointsModalRef(component: Component, points: PointsMySuffix): NgbModalRef {
