...
import be.debaets.health.config.audit.AuditEventConverter;
import be.debaets.health.domain.PersistentAuditEvent;
...
import static be.debaets.health.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
