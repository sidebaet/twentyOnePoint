...
describe('Service Tests', () => {
    ...
    describe('FieldsMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FieldsMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return FieldsMySuffix', () => {

                let entity: FieldsMySuffix;
                service.find(123).subscribe((_entity: FieldsMySuffix) => {
                    entity = _entity;
                });
