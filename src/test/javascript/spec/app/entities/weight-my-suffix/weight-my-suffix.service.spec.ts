...
describe('Service Tests', () => {
    ...
    describe('WeightMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WeightMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return WeightMySuffix', () => {

                let entity: WeightMySuffix;
                service.find(123).subscribe((_entity: WeightMySuffix) => {
                    entity = _entity;
                });
