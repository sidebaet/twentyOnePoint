...
describe('Service Tests', () => {
    ...
    describe('BloodPressureMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BloodPressureMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return BloodPressureMySuffix', () => {

                let entity: BloodPressureMySuffix;
                service.find(123).subscribe((_entity: BloodPressureMySuffix) => {
                    entity = _entity;
                });
